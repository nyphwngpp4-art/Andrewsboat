...
- **Warm intro, not a cold pitch.** Andrew has worked with the family for years, and there's now an open text thread with him about a real repair. Send the demo link into that thread when it's deployed; the pitch arrives as a neighbor showing him something, not a vendor call.
