...
- **Warm intro, not a cold pitch.** Andrew has worked with the family for years, and there's now an open, successful text thread: he talked us through a Tige impeller swap over text, the fix held, and he closed with "let ya know if we run into any more issues." Send the demo link into that thread when it's deployed; the pitch arrives as a neighbor showing him something, not a vendor call. Opener writes itself: "your texts fixed my boat; here's what I built after."
...
8. **Verify contact details.** Phone (325) 320-2018 and Info@andrewsmarine.net are wired throughout - confirm both are current.
